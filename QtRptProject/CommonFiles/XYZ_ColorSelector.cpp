...
XYZ_ColorSelector::XYZ_ColorSelector(QWidget *parent, QString rgbColor)
: QWidget(parent)
{
...
QString XYZ_ColorSelector::getBackGroundColor()
{
...
void XYZ_ColorSelector::setBackGroundColor(QString rgbColor)
{
    QString stl = "QWidget#colorBox {;"
                  "border-width:0px;"
                  "border-style:solid;"
...
void XYZ_ColorSelector::setMargins(QMargins margins)
{
